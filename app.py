...
agent_alias_id = os.environ.get("BEDROCK_AGENT_ALIAS_ID", "VALORANT_TEAM_ALIAS")
ui_title = os.environ.get("BEDROCK_AGENT_UI_TITLE", "VALORANT Team Composition Assistant") # updated spell error 
ui_icon = os.environ.get("BEDROCK_AGENT_UI_ICON")
...
st.set_page_config(page_title=ui_title, page_icon=ui_icon, layout="wide") # layout=wide
st.title(ui_title)
...
# Chat input that invokes the VALORANT assistant agent
if prompt := st.chat_input():
    ...
    with st.chat_message("assistant"):
        ...
        # Invoke the VALORANT team composition assistant
